...
const nombre_alumno = "Ana Gabriela Garcia Hernandez. ";
...
btnGenerar.addEventListener('click', () => {
    ...
    if (correo === "" || !correo.includes('@')) {
        ...
        console.error("No pusiste la arroba ponte listo")
        return;
    }
    ...
    console.log("Se completo la conversion correctamente");
    ...
    console.info(nombre_alumno + "Termino la practica: " + fecha);
});
